...
```{r basic_example, fig.width=8, fig.height=6}
...
```{r advanced_example, fig.width=10, fig.height=8}
# Define gene groups
gene_groups <- list(
...
```{r color_customization, fig.width=10, fig.height=8}
...
```{r font_customization, fig.width=10, fig.height=8}
...
```{r clustering_control, fig.width=10, fig.height=8}
# Custom clustering
...
```{r cell_type, fig.width=10, fig.height=8}
...
3. File an issue on GitHub: https://github.com/xuecheng328/SingleCellComplexHeatMap/issues
